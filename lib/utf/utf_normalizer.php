...
class utf_normalizer
{
	...
	*/
	function cleanup(&$str)
	{
		...
		if (!isset($GLOBALS['utf_nfc_qc']))
		{
			...
			include($root_path . 'lib/utf/data/utf_nfc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_canonical_decomp']))
		{
			global $root_path, $phpEx;
			include($root_path . 'lib/utf/data/utf_canonical_decomp.' . $phpEx);
		}
	...
	*/
	function nfkc(&$str)
	{
		...
		{
			global $root_path, $phpEx;
			include($root_path . 'lib/utf/data/utf_nfkc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_compatibility_decomp']))
		{
			global $root_path, $phpEx;
			include($root_path . 'lib/utf/data/utf_compatibility_decomp.' . $phpEx);
		}
	...
	*/
	function recompose($str, $pos, $len, &$qc, &$decomp_map)
	{
		...
		{
			global $root_path, $phpEx;
			include($root_path . 'lib/utf/data/utf_normalizer_common.' . $phpEx);
		}
		...
		{
			global $root_path, $phpEx;
			include($root_path . 'lib/utf/data/utf_canonical_comp.' . $phpEx);
		}
