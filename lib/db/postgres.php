...
if(!class_exists('phpbb_error_collector')){
	include $phpbb_root_path.'includes/classes/error_collector.'.$phpEx;
}
	...
	public function sql_connect($sqlserver, $sqluser, $sqlpassword, $database, $port = false, $persistency = false, $new_link = false){
		...
		if($this->persistency){
			if(!function_exists('pg_pconnect')){
				$this->connect_error = 'pg_pconnect public function does not exist, is pgsql extension installed?';
			...
			if(!function_exists('pg_connect')){
				$this->connect_error = 'pg_connect public function does not exist, is pgsql extension installed?';
				return $this->sql_error('');
			}
			$collector = new phpbb_error_collector;
			$collector->install();
