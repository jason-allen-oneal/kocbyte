...
class result_mssqlnative{
	...
	private public function array_to_obj($array, &$obj){
...
class dbal_mssqlnative extends dbal{
	...
	* {@inheritDoc}
	*/
	private function sql_lower_text($column_name){
	...
	*/
	public function mssqlnative_num_rows($res){
		if($res !== false){
	...
	*/
	public function mssqlnative_set_query_options($options){
