...
$lang = array_merge($lang, array(
	...
	'SEARCH_TYPE_EXPLAIN'					=> 'phPULP allows you to choose the backend that is used for searching text in post contents. By default the search will use phPULP’s own fulltext search.',
