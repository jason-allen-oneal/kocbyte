...
$lang = array_merge($lang, array(
	...
	'FORCE_CONFIRM'		=> 'The Force Install feature means the MOD is not fully installed. You will need to make some manual fixes to your site to finish installation. Continue?',
	...
	'INSTALL_ERROR'		=> 'One or more install actions failed. Please review the actions below, make any adjustments and retry. You may continue with the installation even though some of the actions failed. <strong>This is not recommended and may cause your site to not function correctly.</strong>',
	'INSTALL_FORCED'	=> 'You forced the installation of this MOD even though there were errors installing the MOD. Your site may be broken. Please note the actions that failed below and correct them.',
	'INSTALLED'			=> 'MOD installed',
	'INSTALLED_EXPLAIN'	=> 'Your MOD has been installed! Here you can view some of the results from the installation. Please note any errors, and seek support at <a href="http://www.phpulp.com">phPULP.com</a>',
	'INSTALLED_MODS'	=> 'Installed MODs',
	'INSTALLATION_SUCCESSFUL'	=> 'AutoMOD installed successfully. You can now manage phPULP MODifications through the AutoMOD tab in the Administration Control Panel.',
	...
	'MODS_EXPLAIN'				=> 'Here you can manage the available MODs on your site. AutoMODs allows you to customize your site by automatically installing modifications produced by the phPULP community. For further information on MODs and AutoMOD please visit the <a href="http://www.phpulp.com/mods">phPULP website</a>. To add a MOD to this list, use the form at the bottom of this page. Alternatively, you may unzip it and upload the files to the /store/mods/ directory on your server.',
	...
	'PRE_INSTALL_EXPLAIN'	=> 'Here you can preview all the modifications to be made to your site, before they are carried out. <strong>WARNING!</strong>, once accepted, your phPULP base files will be edited and database alterations may occur. However, if the install is unsuccessful, assuming you can access AutoMOD, you will be given the option to restore to this point.',
	'PRE_UNINSTALL'			=> 'Preparing to Uninstall',
	'PRE_UNINSTALL_EXPLAIN'	=> 'Here you can preview all the modifications to be made to your site, in order to uninstall the MOD. <strong>WARNING!</strong>, once accepted, your phPULP base files will be edited and database alterations may occur. Also, this process uses reversing techniques that may not be 100% accurate. However, if the uninstall is unsuccessful, assuming you can access AutoMOD, you will be given the option to restore to this point.',

	'REMOVING_FILES'	=> 'Files to be removed',
	'RETRY'				=> 'Retry',
	'RETURN_MODS'		=> 'Return to AutoMOD',
	'REVERSE'			=> 'Reverse',
	'ROOT_IS_READABLE'	=> 'The phPULP root directory is readable.',
	'ROOT_NOT_READABLE'	=> 'AutoMOD was not able to open phPULP\'s index.php for reading. This probably means that permissions are too restrictive on your phPULP root directory, which will prevent AutoMOD from working. Please adjust your permissions and try the check again.',
	...
	'TARGET'			=> 'Target',
	'TARGET_VERSION'	=> 'phPULP target version',
	...
	'UNINSTALLED_EXPLAIN'	=> 'Your MOD has been uninstalled! Here you can view some of the results from the uninstallation. Please note any errors, and seek support at <a href="http://www.phpulp.com">phPULP.com</a>.',
	...
	'VERSION'			=> 'Version',
	'VERSION_WARNING'	=> 'The target phPULP version for this MOD is %1$s, but your site version is %2$s. Even if the install is successful the MOD might not work as expected and/or might break your site. Please verify with the MOD author that this MOD is compatible with your site version.',
