...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>These are used to control access on a global level and apply to the entire site. They are further divided into User Permissions, Group Permissions, Administrators and Global Moderators.</p>

		<h3>Permission Roles</h3>
		<p>These are used to create different sets of permissions for the different permission types later being able to be assigned on a role-based basis. The default roles should cover the administration of sites large and small, though within each of the four divisions, you can add/edit/delete roles as you see fit.</p>

		<h3>Permission Masks</h3>
		<p>These are used to view the effective permissions assigned to Users, Moderators (Local and Global), or Administrators.</p>',
	...
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'Here you can assign global moderator permissions to users or groups. These moderators are like ordinary moderators except they have access to every forum on your site.',
	...
	'ROLE_DESCRIPTION_ADMIN_FULL'			=> 'Has access to all administrative functions of this site.<br />Not recommended.',
	...
	'WRONG_PERMISSION_SETTING_FORMAT'	=> 'The permission settings are in a wrong format, phPULP is not able to process them correctly.',
));
