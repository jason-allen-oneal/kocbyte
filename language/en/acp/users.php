...
$lang = array_merge($lang, array(
	...
	'AT_LEAST_ONE_FOUNDER'	=> 'You are not able to change this founder to a normal user. There needs to be at least one founder enabled for this site. If you want to change this users founder status, promote another user to be a founder first.',
