...
$lang = array_merge($lang, array(
	'ACP_SITE_SETTINGS_EXPLAIN'	=> 'Here you can determine the basic operation of your site, give it a fitting name and description, and among other settings adjust the default values for timezone and language.',
	...
	'DISABLE_SITE_EXPLAIN'			=> 'This will make the site unavailable to users. You can also enter a short (255 character) message to display if you wish.',
...
// Board Features
$lang = array_merge($lang, array(
	'ACP_SITE_FEATURES_EXPLAIN'	=> 'Here you can enable/disable several site features.',

	'ALLOW_ATTACHMENTS'			=> 'Allow attachments',
	'ALLOW_BIRTHDAYS'			=> 'Allow birthdays',
	'ALLOW_BIRTHDAYS_EXPLAIN'	=> 'Allow birthdays to be entered and age being displayed in profiles. Please note the birthday list within the site index is controlled by a separate load setting.',
	...
	'ALLOW_SITE_NOTIFY'		=> 'Allow subscribing to sites',
	...
	'ALLOW_PM_REPORT_EXPLAIN'	=> 'If this setting is enabled, users have the option of reporting a private message they have received or sent to the site’s moderators. These private messages will then be visible in the Moderator Control Panel.',
	'ALLOW_QUICK_REPLY'			=> 'Allow quick reply',
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'This switch allows for the quick reply to be disabled site-wide. When enabled, site specific settings will be used to determine whether the quick reply is displayed in individual sites.',
	'ALLOW_QUICK_REPLY_BUTTON'	=> 'Submit and enable quick reply in all sites',
	...
	'SITE_PM'					=> 'Private messaging',
	'SITE_PM_EXPLAIN'			=> 'Enable private messaging for all users.',
));
...
$lang = array_merge($lang, array(
	...
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Path under your phPULP root directory for pre-loaded images, e.g. <samp>images/avatars/gallery</samp>.',
	'AVATAR_STORAGE_PATH'			=> 'Avatar storage path',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Path under your phPULP root directory, e.g. <samp>images/avatars/upload</samp>.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'		=> 'This determines whether users have immediate access to the site or if confirmation is required. You can also completely disable new registrations. “Site-wide e-mail” must be enabled in order to use user or admin activation.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_SITE'					=> 'Enable per-site feeds',
	'ACP_FEED_SITE_EXPLAIN'			=> 'Single site and subsites new posts.',
	...
	'ACP_FEED_NEWS_EXPLAIN'				=> 'Pull the first post from these sites. Select no sites to disable news feed.<br />Select multiple sites by holding <samp>CTRL</samp> and clicking.',

	'ACP_FEED_OVERALL_SITES'			=> 'Enable sites feed',
	'ACP_FEED_OVERALL_SITES_EXPLAIN'	=> 'Enables the “All sites” feed, which displays a list of sites.',
	...
	'ACP_FEED_EXCLUDE_ID'				=> 'Exclude these sites',
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'		=> 'Content from these will be <strong>not included in feeds</strong>. Select no site to pull data from all sites.<br />Select/Deselect multiple sites by holding <samp>CTRL</samp> and clicking.',
));
...
$lang = array_merge($lang, array(
	...
	'LOAD_USER_ACTIVITY_EXPLAIN'	=> 'Displays active topic/site in user profiles and user control panel. It is recommended to disable this on sites with more than one million posts.',
	...
	'YES_ONLINE_EXPLAIN'			=> 'Display online user information on index, site and topic pages.',
...
// Auth settings
$lang = array_merge($lang, array(
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'phPULP supports authentication plug-ins, or modules. These allow you determine how users are authenticated when they log into the site. By default three plug-ins are provided; DB, LDAP and Apache. Not all methods require additional information so only fill out fields if they are relevant to the selected method.',

	'AUTH_METHOD'				=> 'Select an authentication method',

	'APACHE_SETUP_BEFORE_USE'	=> 'You have to setup apache authentication before you switch phPULP to this authentication method. Keep in mind that the username you use for apache authentication has to be the same as your phPULP username. Apache authentication can only be used with mod_php (not with a CGI version) and safe_mode disabled.',
	...
	'LDAP_USER_EXPLAIN'				=> 'Leave blank to use anonymous binding. If filled in phPULP uses the specified distinguished name on login attempts to find the correct user, e.g. <samp>uid=Username,ou=MyUnit,o=MyCompany,c=US</samp>. Required for Active Directory Servers.',
...
$lang = array_merge($lang, array(
	...
	'ICONS_PATH_EXPLAIN'		=> 'Path under your phPULP root directory, e.g. <samp>images/icons</samp>.',
	'PATH_SETTINGS'				=> 'Path settings',
	'RANKS_PATH'				=> 'Rank image storage path',
	'RANKS_PATH_EXPLAIN'		=> 'Path under your phPULP root directory, e.g. <samp>images/ranks</samp>.',
	...
	'SMILIES_PATH_EXPLAIN'		=> 'Path under your phPULP root directory, e.g. <samp>images/smilies</samp>.',
	'UPLOAD_ICONS_PATH'			=> 'Extension group icons storage path',
	'UPLOAD_ICONS_PATH_EXPLAIN'	=> 'Path under your phPULP root directory, e.g. <samp>images/upload_icons</samp>.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Determines whether users can autologin when they visit the site.',
	...
	'REFERER_VALID_EXPLAIN'			=> 'If enabled, the referer of POST requests will be checked against the host/script path settings. This may cause issues with sites using several domains and or external logins.',
...
// Email Settings
$lang = array_merge($lang, array(
	'ACP_EMAIL_SETTINGS_EXPLAIN'	=> 'This information is used when the site sends e-mails to your users. Please ensure the e-mail address you specify is valid, any bounced or undeliverable messages will likely be sent to that address. If your host does not provide a native (PHP based) e-mail service you can instead send messages directly using SMTP. This requires the address of an appropriate server (ask your provider if necessary). If the server requires authentication (and only if it does) enter the necessary username, password and authentication method.',
