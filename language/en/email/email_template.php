...
<body>
	<center class="wrapper">
		<table class="gmail"><tbody><tr><td>&nbsp;</td></tr></tbody></table>
		<table class="header centered">
			<tbody><tr><td class="border">&nbsp;</td></tr>
			<tr><td class="logo"><div align="center" class="logo-center" id="emb-email-header"><a href="http://www.beansworthy.com/"><img width="300" height="40" style="max-width:371px" alt="logo" src="http://www.beansworthy.com/styles/Default/imageset/site_logo.png"></a></div></td></tr>
		</tbody></table>
      
		<table width="602" style="Margin-left:auto;Margin-right:auto;" class="border">
			<tbody><tr><td>&#8203;</td></tr>
		</tbody></table>
                        ...
                        <table class="contents">
                          <tbody><tr>
                            <td class="padded">
								...
								<hr />
								<p>What is BeansWorthy?</p>
								<strong>REMEMBER</strong> things you haven't thought about in years<br />
								<strong>ANSWER</strong> questions from different periods in your life<br />
								<strong>COMMENT</strong> on events that happened throughout your life<br />
								<strong>VIEW</strong> videos covering just about everything that happened during your life<br />
								<strong>CREATE</strong> your own Personal History Story – we do all of the work<br />
								<strong>SHARE</strong> with others if you want or keep it to yourself<br />
								We have the questions and only you have the answers<br />
								<br />
								<a href="http://www.beansworthy.com">It's Free - have fun! Click here to visit BeansWorthy.com</a>
                            </td>
                          </tr>
                        </tbody></table>
      ...
      <div style="line-height:32px;" class="spacer">&nbsp;</div>
              ...
              <tbody><tr>
                <td class="address">
                  <table class="contents">
                    <tbody><tr>
                      <td class="padded">
                        BeansWorthy.com - 8011 North Point Blvd, Ste 201, Winston-Salem, NC  27106
                      </td>
                    </tr>
                  </tbody></table>
                </td>
