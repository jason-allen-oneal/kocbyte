...
$lang = array_merge($lang, array(
	...
	<br />
	Our site is powered by FluidVector Design\'s phPUPLP (hereinafter “they”, “them”, “their”, “phPULP software”, “www.phpulp.com”, “FluidVector”, “FluidVector Design”) which is a website framework released under the “<a href="http://opensource.org/licenses/gpl-license.php">General Public License</a>” (hereinafter “GPL”) and can be downloaded from <a href="http://www.phpulp.com/">www.phpulp.com</a>. The phPULP software only facilitates website functionality, FluidVector Design is not responsible for what we allow and/or disallow as permissible content and/or conduct. For further information about phPULP, please see: <a href="http://www.phpulp.com/">http://www.phpulp.com/</a>.<br />
	<br />
	You agree not to post any abusive, obscene, vulgar, slanderous, hateful, threatening, sexually-orientated or any other material that may violate any laws be it of your country, the country where “%1$s” is hosted or International Law. Doing so may lead to you being immediately and permanently banned, with notification of your Internet Service Provider if deemed required by us. The IP address of all posts are recorded to aid in enforcing these conditions. You agree that “%1$s” have the right to remove, edit, move or close any topic at any time should we see fit. As a user you agree to any information you have entered to being stored in a database. While this information will not be disclosed to any third party without your consent, neither “%1$s” nor FluidVector shall be held responsible for any hacking attempt that may lead to the data being compromised.',

	'PRIVACY_POLICY'		=> 'This policy explains in detail how “%1$s” along with its affiliated companies (hereinafter “we”, “us”, “our”, “%1$s”, “%2$s”) and phPULP (hereinafter “they”, “them”, “their”, “phPULP software”, “www.phpulp.com”, “FluidVector”, “FluidVector Design”) use any information collected during any session of usage by you (hereinafter “your information”).<br />
	<br />
	Your information is collected via two ways. Firstly, by browsing “%1$s” will cause the phPULP software to create a number of cookies, which are small text files that are downloaded on to your computer’s web browser temporary files. The first two cookies just contain a user identifier (hereinafter “user-id”) and an anonymous session identifier (hereinafter “session-id”), automatically assigned to you by the phPULP software. A third cookie will be created once you have browsed “%1$s” and is used to store which items have been read, thereby improving your user experience.<br />
	<br />
	We may also create cookies external to the phPULP software whilst browsing “%1$s”, though these are outside the scope of this document which is intended to only cover the pages created by the phPULP software. The second way in which we collect your information is by what you submit to us. This can be, and is not limited to: posting as an anonymous user (hereinafter “anonymous posts”), registering on “%1$s” (hereinafter “your account”) and posts submitted by you after registration and whilst logged in (hereinafter “your posts”).<br />
	<br />
	Your account will at a bare minimum contain a uniquely identifiable name (hereinafter “your user name”), a personal password used for logging into your account (hereinafter “your password”) and a personal, valid e-mail address (hereinafter “your e-mail”). Your information for your account at “%1$s” is protected by data-protection laws applicable in the country that hosts us. Any information beyond your user name, your password, and your e-mail address required by “%1$s” during the registration process is either mandatory or optional, at the discretion of “%1$s”. In all cases, you have the option of what information in your account is publicly displayed. Furthermore, within your account, you have the option to opt-in or opt-out of automatically generated e-mails from the phPULP software.<br />
	<br />
	Your password is ciphered (a one-way hash) so that it is secure. However, it is recommended that you do not reuse the same password across a number of different websites. Your password is the means of accessing your account at “%1$s”, so please guard it carefully and under no circumstance will anyone affiliated with “%1$s”, phPULP or another 3rd party, legitimately ask you for your password. Should you forget your password for your account, you can use the “I forgot my password” feature provided by the phPULP software. This process will ask you to submit your user name and your e-mail, then the phPULP software will generate a new password to reclaim your account.<br />
	',
));
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED'			=> 'Your account has been updated. However, this site requires account reactivation on e-mail changes. An activation key has been sent to the new e-mail address you provided. Please check your e-mail for further information.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Your account has been updated. However, this site requires account reactivation by the administrators on e-mail changes. An e-mail has been sent to them and you will be informed when your account has been reactivated.',
	'ACCOUNT_INACTIVE'				=> 'Your account has been created. However, this site requires account activation, an activation key has been sent to the e-mail address you provided. Please check your e-mail for further information. <strong>Please be sure to add BeansWorthy.com to your address book, or whitelist, “%s”.</strong>',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Your account has been created. However, this site requires account activation by the administrator group. An e-mail has been sent to them and you will be informed when your account has been activated.',
	...
	'AVATAR_FEATURES_DISABLED'		=> 'The profile picture functionality is currently disabled.',
	'AVATAR_GALLERY'				=> 'Local gallery',
	'AVATAR_GENERAL_UPLOAD_ERROR'	=> 'Could not upload profile picture to %s.',
	'AVATAR_NOT_ALLOWED'			=> 'Your profile picture cannot be displayed because profile pictures have been disallowed.',
	'AVATAR_PAGE'					=> 'Page',
	'AVATAR_TYPE_NOT_ALLOWED'		=> 'Your current profile picture cannot be displayed because its type has been disallowed.',

	'BACK_TO_DRAFTS'			=> 'Back to saved drafts',
	'BACK_TO_LOGIN'				=> 'Back to login screen',
	'BIRTHDAY'					=> 'Birthday',
	'BIRTHDAY_EXPLAIN'			=> 'Setting a year will list your age when it is your birthday.',
	'SITE_DATE_FORMAT'			=> 'My date format',
	'SITE_DATE_FORMAT_EXPLAIN'	=> 'The syntax used is identical to the PHP <a href="http://www.php.net/date">date()</a> function.',
	'SITE_DST'					=> 'Summer Time/<abbr title="Daylight Saving Time">DST</abbr> is in effect',
	'SITE_LANGUAGE'			=> 'My language',
	'SITE_STYLE'				=> 'My style',
	'SITE_TIMEZONE'			=> 'My timezone',
	'BOOKMARKS'					=> 'Bookmarks',
	...
	'LINK_REMOTE_AVATAR_EXPLAIN'=> 'Enter the URL of the location containing the profile picture image you wish to link to.',
	'LINK_REMOTE_SIZE'			=> 'Profile picture dimensions',
	'LINK_REMOTE_SIZE_EXPLAIN'	=> 'Specify the width and height of the profile picture, leave blank to attempt automatic verification.',
	...
	'UCP_PROFILE'				=> 'Profile',
	'UCP_PROFILE_AVATAR'		=> 'Profile Pictures',
	'UCP_PROFILE_PICS'			=> 'Profile Pics',
	'UCP_PROFILE_PROFILE_INFO'	=> 'Profile Info',
	'UCP_PROFILE_REG_DETAILS'	=> 'Account',
	'UCP_PROFILE_ADDRESS'		=> 'Address Book',
	'UCP_PROFILE_ADDRESS_BOOK'	=> 'Address Book',
	'UCP_PROFILE_ENTRY_DELETE'	=> 'Delete Address Book Entry',
	'UCP_PROFILE_ENTRY_DELETE_CONFIRM' => 'Are you sure you want to delete this entry from your Address Book?',
	'UCP_QUESTION_RESPONSE_DELETE' => 'Delete Response',
	'UCP_QUESTION_RESPONSE_DELETE_CONFIRM' => 'Are you sure you want to delete this response?',
	...
	'UCP_QUESTIONS'				=> 'Questions',
	'UCP_QUESTIONS_OVERVIEW'	=> 'Overview',
	'UCP_QUESTIONS_ANSWERED'	=> 'Answered',
	'UCP_QUESTIONS_ADD'			=> 'Add Question',
	'UCP_QUESTIONS_PROFILE'		=> 'View Personal History Story',
	'UCP_QUESTIONS_SHARE'		=> 'Share Personal History',

	'UCP_REGISTER_DISABLE'			=> 'Creating a new account is currently not possible.',
	'UCP_REMIND'					=> 'Send password',
	'UCP_RESEND'					=> 'Send activation e-mail',
	'UCP_WELCOME'					=> 'Welcome to the User Control Panel. From here you can monitor, view and update your profile, preferences, and answers.',
	...
	'VIEW_AVATARS'				=> 'Display profile pictures',
	'VIEW_EDIT'					=> 'View/Edit',
