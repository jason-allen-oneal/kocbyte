...
$lang = array_merge($lang, array(
	...
	'BOARD_NOT_INSTALLED_EXPLAIN'	=> 'The phPULP Unified Convertor Framework requires a default installation of phPULP to function, please <a href="%s">proceed by first installing phPULP</a>.',
	...
	'CONFIG_PHPBB_EMPTY'		=> 'The phPULP config variable for “%s” is empty.',
	'CONFIG_RETRY'				=> 'Retry',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'You have now successfully converted your site to phPULP. You can now login and <a href="../">access your site</a>. Please ensure that the settings were transferred correctly before enabling your site by deleting the install directory.',
	'CONVERT_INTRO'				=> 'Welcome to the phPULP Unified Convertor Framework',
	'CONVERT_INTRO_BODY'		=> 'From here, you are able to import data from other (installed) site systems. The list below shows all the conversion modules currently available. If there is no convertor shown in this list for the site software you wish to convert from, please check our website where further conversion modules may be available for download.',
	...
	'CONV_ERROR_NO_FORUM_PATH'			=> 'The relative path to the source site has not been specified.',
	...
	'CONV_OPTIONS_BODY'					=> 'This page collects the data required to access the source site. Enter the database details of your former site; the converter will not change anything in the database given below. The source site should be disabled to allow a consistent conversion.',
	...
	'COULD_NOT_FIND_PATH'		=> 'Could not find path to your former site. Please check your settings and try again.<br />» %s was specified as the source path.',
	...
	'DB_UPDATE_NOT_SUPPORTED'	=> 'We are sorry, but this script does not support updating from versions of phPULP prior to “%1$s”. The version you currently have installed is “%2$s”. Please update to a previous version before running this script. Assistance with this is available in the Support Forum on phPULP.com.',
	...
	'DL_CONFIG_EXPLAIN'			=> 'You may download the complete config.php to your own PC. You will then need to upload the file manually, replacing any existing config.php in your phPULP root directory. Please remember to upload the file in ASCII format (see your FTP application documentation if you are unsure how to achieve this). When you have uploaded the config.php please click “Done” to move to the next stage.',
	...
	'FILES_REQUIRED_EXPLAIN'	=> '<strong>Required</strong> - In order to function correctly phPULP needs to be able to access or write to certain files or directories. If you see “Not Found” you need to create the relevant file or directory. If you see “Unwritable” you need to change the permissions on the file or directory to allow phPULP to write to it.',
	'FILLING_TABLE'				=> 'Filling table <strong>%s</strong>',
	'FILLING_TABLES'			=> 'Filling tables',

	'FIREBIRD_DBMS_UPDATE_REQUIRED'		=> 'phPULP no longer supports Firebird/Interbase prior to Version 2.1. Please update your Firebird installation to at least 2.1.0 before proceeding with the update.',

	'FINAL_STEP'				=> 'Process final step',
	'FORUM_ADDRESS'				=> 'site address',
	'FORUM_ADDRESS_EXPLAIN'		=> 'This is the URL of your former site, for example <samp>http://www.example.com/phPULP/</samp>. If an address is entered here and not left empty every instance of this address will be replaced by your new site address within messages, private messages and signatures.',
	'FORUM_PATH'				=> 'Site path',
	'FORUM_PATH_EXPLAIN'		=> 'This is the <strong>relative</strong> path on disk to your former site from the <strong>root of this phPULP installation</strong>.',
	'FOUND'						=> 'Found',
	'FTP_CONFIG'				=> 'Transfer config by FTP',
	'FTP_CONFIG_EXPLAIN'		=> 'phPULP has detected the presence of the FTP module on this server. You may attempt to install your config.php via this if you wish. You will need to supply the information listed below. Remember your username and password are those to your server! (ask your hosting provider for details if you are unsure what these are).',
	'FTP_PATH'					=> 'FTP path',
	'FTP_PATH_EXPLAIN'			=> 'This is the path from your root directory to that of phPULP, e.g. <samp>htdocs/phPULP/</samp>.',
	'FTP_UPLOAD'				=> 'Upload',

	'GPL'						=> 'General Public License',

	'INITIAL_CONFIG'			=> 'Basic configuration',
	'INITIAL_CONFIG_EXPLAIN'	=> 'Now that install has determined your server can run phPULP you need to supply some specific information. If you do not know how to connect to your database please contact your hosting provider (in the first instance) or use the phPULP support forums. When entering data please ensure you check it thoroughly before continuing.',
	'INSTALL_CONGRATS'			=> 'Congratulations!',
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		You have successfully installed phPULP %1$s. Please proceed by choosing one of the following options:</p>
		<h2>Convert an existing site to phPULP</h2>
		<p>The phPULP Unified Convertor Framework supports the conversion of phPULP 2.0.x and other site systems to phPULP. If you have an existing site that you wish to convert, please <a href="%2$s">proceed to the convertor</a>.</p>
		<h2>Go live with your phPULP!</h2>
		<p>Clicking the button below will take you to a form for submitting statistical data to phPULP in your Administration Control Panel (ACP). We would appreciate it if you could help us by sending that information. Afterwards you should take some time to examine the options available to you.</p><p><strong>Please delete, move or rename the install directory before using your site. While this directory exists, only the Administration Control Panel (ACP) will be accessible.</strong>',
	'INSTALL_INTRO'				=> 'Welcome to Installation',

	'INSTALL_INTRO_BODY'		=> 'With this option, it is possible to install phPULP onto your server.</p><p>In order to proceed, you will need your database settings. If you do not know your database settings, please contact your host and ask for them. You will not be able to continue without them. You need:</p>
	...
	<p>phPULP supports the following databases:</p>
	<ul>
	...
	'INSTALL_SEND_CONFIG'		=> 'Unfortunately phPULP could not write the configuration information directly to your config.php. This may be because the file does not exist or is not writable. A number of options will be listed below enabling you to complete installation of config.php.',
	'INSTALL_START'				=> 'Start install',
	'INSTALL_TEST'				=> 'Test again',
	'INST_ERR'					=> 'Installation error',
	'INST_ERR_DB_CONNECT'		=> 'Could not connect to the database, see error message below.',
	'INST_ERR_DB_FORUM_PATH'	=> 'The database file specified is within your site directory tree. You should put this file in a non web-accessible location.',
	...
	'MBSTRING_CHECK_EXPLAIN'				=> '<strong>Required</strong> - <samp>mbstring</samp> is a PHP extension that provides multibyte string functions. Certain features of mbstring are not compatible with phPULP and must be disabled.',
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'	=> 'Your MySQL database schema for phPULP is outdated. phPULP detected a schema for MySQL 3.x/4.x, but the server runs on MySQL %2$s.<br /><strong>Before you proceed the update, you need to upgrade the schema.',
	...
	'OVERVIEW_BODY'				=> 'Welcome to phPULP!<br /><br />phPULP® is the most widely used open source bulletin site solution in the world. phPULP is the latest installment in a package line started in 2000. Like its predecessors, phPULP is feature-rich, user-friendly, and fully supported by the phPULP Team. We hope it exceeds your expectations.<br /><br />This installation system will guide you through installing phPULP, updating to the latest version of phPULP from past releases, as well as converting to phPULP from a different discussion site system. For more information, we encourage you to read <a href="../docs/INSTALL.html">the installation guide</a>.<br /><br />To read the phPULP license or learn about obtaining support and our stance on it, please select the respective options from the side menu. To continue, please select the appropriate tab above.',

	'PCRE_UTF_SUPPORT'				=> 'PCRE UTF-8 support',
	'PCRE_UTF_SUPPORT_EXPLAIN'		=> 'phPULP will <strong>not</strong> run if your PHP installation is not compiled with UTF-8 support in the PCRE extension.',
	'PHP_GETIMAGESIZE_SUPPORT'			=> 'PHP function getimagesize() is available',
	'PHP_GETIMAGESIZE_SUPPORT_EXPLAIN'	=> '<strong>Required</strong> - In order for phPULP to function correctly, the getimagesize function needs to be available.',
	...
	'PHP_REGISTER_GLOBALS_EXPLAIN'	=> 'phPULP will still run if this setting is enabled, but if possible, it is recommended that register_globals is disabled on your PHP install for security reasons.',
	'PHP_SAFE_MODE'					=> 'Safe mode',
	'PHP_SETTINGS'					=> 'PHP version and settings',
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Required</strong> - You must be running at least version 4.3.3 of PHP in order to install phPULP. If <var>safe mode</var> is displayed below your PHP installation is running in that mode. This will impose limitations on remote administration and similar features.',
	'PHP_URL_FOPEN_SUPPORT'			=> 'PHP setting <var>allow_url_fopen</var> is enabled',
	'PHP_URL_FOPEN_SUPPORT_EXPLAIN'	=> '<strong>Optional</strong> - This setting is optional, however certain phPULP functions like off-site avatars will not work properly without it.',
	...
	'REQUIREMENTS_EXPLAIN'		=> 'Before proceeding with the full installation phPULP will carry out some tests on your server configuration and files to ensure that you are able to install and run phPULP. Please ensure you read through the results thoroughly and do not proceed until all the required tests are passed. If you wish to use any of the features depending on the optional tests, you should ensure that these tests are passed also.',
	'RETRY_WRITE'				=> 'Retry writing config',
	'RETRY_WRITE_EXPLAIN'		=> 'If you wish you can change the permissions on config.php to allow phPULP to write to it. Should you wish to do that you can click Retry below to try again. Remember to return the permissions on config.php after phPULP has finished installation.',

	'SCRIPT_PATH'				=> 'Script path',
	'SCRIPT_PATH_EXPLAIN'		=> 'The path where phPULP is located relative to the domain name, e.g. <samp>/phPULP</samp>.',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'	=> 'The database tables used by phPULP have been created and populated with some initial data. Proceed to the next screen to finish installing phPULP.',
	...
	'SUPPORT_BODY'				=> 'Full support will be provided for the current stable release of phPULP, free of charge. This includes:</p><ul><li>installation</li><li>configuration</li><li>technical questions</li><li>problems relating to potential bugs in the software</li><li>updating from Release Candidate (RC) versions to the latest stable version</li><li>converting from phPULP 2.0.x to phPULP</li><li>converting from other discussion site software to phPULP (please see the <a href="https://www.phPULP.com/community/viewforum.php?f=65">Convertors Forum</a>)</li></ul><p>We encourage users still running beta versions of phPULP to replace their installation with a fresh copy of the latest version.</p><h2>MODs / Styles</h2><p>For issues relating to MODs, please post in the appropriate <a href="https://www.phPULP.com/community/viewforum.php?f=81">Modifications Forum</a>.<br />For issues relating to styles, templates and imagesets, please post in the appropriate <a href="https://www.phPULP.com/community/viewforum.php?f=80">Styles Forum</a>.<br /><br />If your question relates to a specific package, please post directly in the topic dedicated to the package.</p><h2>Obtaining Support</h2><p><a href="https://www.phPULP.com/community/viewtopic.php?f=14&amp;t=571070">The phPULP Welcome Package</a><br /><a href="https://www.phPULP.com/support/">Support Section</a><br /><a href="https://www.phPULP.com/support/documentation/3.0/quickstart/">Quick Start Guide</a><br /><br />To ensure you stay up to date with the latest news and releases, why not <a href="https://www.phPULP.com/support/">subscribe to our mailing list</a>?<br /><br />',
	...
	'WELCOME_INSTALL'			=> 'Welcome to phPULP Installation',
	'WRITABLE'					=> 'Writable',
));

// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'All files are up to date with the latest phPULP version. You should now <a href="../ucp.php?mode=login">login to your site</a> and check if everything is working fine. Do not forget to delete, rename or move your install directory! Please send us updated information about your server and site configurations from the <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics">Send statistics</a> module in your ACP.',
	...
	'CHECK_FILES_UP_TO_DATE'		=> 'According to your database your version is up to date. You may want to proceed with the file check to make sure all files are really up to date with the latest phPULP version.',
	...
	'COMPLETE_LOGIN_TO_BOARD'		=> 'You should now <a href="../ucp.php?mode=login">login to your site</a> and check if everything is working fine. Do not forget to delete, rename or move your install directory!',
	...
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Once downloaded you should unpack the archive. You will find the modified files you need to upload to your phPULP root directory within it. Please upload the files to their respective locations then. After you have uploaded all files, please check the files again with the other button below.',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'The following files are not modified and represent the original phPULP files from the version you want to update from.',
	'FILES_UP_TO_DATE'				=> 'Already updated files',
	'FILES_UP_TO_DATE_EXPLAIN'		=> 'The following files are already up to date and do not need to be updated.',
	'FTP_SETTINGS'					=> 'FTP settings',
	'FTP_UPDATE_METHOD'				=> 'FTP upload',

	'INCOMPATIBLE_UPDATE_FILES'		=> 'The update files found are incompatible with your installed version. Your installed version is %1$s and the update file is for updating phPULP %2$s to %3$s.',
	...
	'MAPPING_FILE_STRUCTURE'	=> 'To ease the upload here are the file locations which map your phPULP installation.',
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Merge modifications (removes new phPULP code within conflicting block)',
	...
	'MERGING_FILES_EXPLAIN'		=> 'Currently collecting final file changes.<br /><br />Please wait until phPULP has completed all operations on changed files.',
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'No valid update directory was found, please make sure you uploaded the relevant files.<br /><br />Your installation does <strong>not</strong> seem to be up to date. Updates are available for your version of phPULP %1$s, please visit <a href="https://www.phPULP.com/downloads/" rel="external">https://www.phPULP.com/downloads/</a> to obtain the correct package to update from Version %2$s to Version %3$s.',
	...
	'OLD_UPDATE_FILES'		=> 'Update files are out of date. The update files found are for updating from phPULP %1$s to phPULP %2$s but the latest version of phPULP is %3$s.',
	...
	'UPDATE_FILES_NOTICE'			=> 'Please make sure you have updated your site files too, this file is only updating your database.',
	'UPDATE_INSTALLATION'			=> 'Update phPULP installation',
	'UPDATE_INSTALLATION_EXPLAIN'	=> 'With this option, it is possible to update your phPULP installation to the latest version.<br />During the process all of your files will be checked for their integrity. You are able to review all differences and files before the update.<br /><br />The file update itself can be done in two different ways.</p><h2>Manual Update</h2><p>With this update you only download your personal set of changed files to make sure you do not lose your file modifications you may have done. After you downloaded this package you need to manually upload the files to their correct position under your phPULP root directory. Once done, you are able to do the file check stage again to see if you moved the files to their correct location.</p><h2>Automatic Update with FTP</h2><p>This method is similar to the first one but without the need to download the changed files and uploading them on your own. This will be done for you. In order to use this method you need to know your FTP login details since you will be asked for them. Once finished you will be redirected to the file check again to make sure everything got updated correctly.<br /><br />',
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>The recommended way of updating your installation listed here is only valid for the automatic update package. You are also able to update your installation using the methods listed within the INSTALL.html document. The steps for updating phPULP automatically are:</p>

		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Go to the <a href="https://www.phPULP.com/downloads/" title="https://www.phPULP.com/downloads/">phPULP.com downloads page</a> and download the "Automatic Update Package" archive.<br /><br /></li>
			<li>Unpack the archive.<br /><br /></li>
			<li>Upload the complete uncompressed install folder to your phPULP root directory (where your config.php file is).<br /><br /></li>
		</ul>

		<p>Once uploaded your site will be offline for normal users due to the install directory you uploaded now present.<br /><br />
	...
	'UPDATE_INSTRUCTIONS_INCOMPLETE'	=> '
		...
		<p>phPULP detected an incomplete automatic update. Please make sure you followed every step within the automatic update tool. Below you will find the link again, or go directly to your install directory.</p>
	',
	...
	'VERSION_CHECK_EXPLAIN'			=> 'Checks to see if your phPULP installation is up to date.',
	'VERSION_NOT_UP_TO_DATE'		=> 'Your phPULP installation is not up to date. Please continue the update process.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Your phPULP installation is not up to date.<br />Below is a link to the release announcement, which contains more information as well as instructions on updating.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'Your phPULP installation is not up to date.',
	'VERSION_UP_TO_DATE'			=> 'Your phPULP installation is up to date. Although there are no updates available at this time, you may continue in order to perform a file validity check.',
	'VERSION_UP_TO_DATE_ACP'		=> 'Your phPULP installation is up to date. There are no updates available at this time.',
...
$lang = array_merge($lang, array(
	...
	'TOPICS_TOPIC_TITLE'			=> 'Welcome to phPULP',
));
