...
$lang = array_merge($lang, array(
	...
	'ACTIVE'						=> 'active',
	'ACTIVE_ERROR'					=> 'The specified username is currently inactive. If you have problems activating your account, please contact a site administrator.',
	...
	'BCC'					=> 'BCC',
	'BIRTHDAYS'				=> 'Birthdays',
	'SITE_BAN_PERM'		=> 'You have been <strong>permanently</strong> banned from this site.<br /><br />Please contact the %2$sSite Administrator%3$s for more information.',
	'SITE_BAN_REASON'		=> 'Reason given for ban: <strong>%s</strong>',
	'SITE_BAN_TIME'		=> 'You have been banned from this site until <strong>%1$s</strong>.<br /><br />Please contact the %2$sSite Administrator%3$s for more information.',
	'SITE_DISABLE'			=> 'Sorry but this site is currently unavailable.',
	'SITE_DISABLED'		=> 'This site is currently disabled.',
	'SITE_UNAVAILABLE'		=> 'Sorry but the site is temporarily unavailable, please try again in a few minutes.',
	'BYTES'					=> 'Bytes',

	'CANCEL'				=> 'Cancel',
	'CHANGE'				=> 'Change',
	'CHANGE_FONT_SIZE'		=> 'Change font size',
	'CHANGING_PREFERENCES'	=> 'Changing site preferences',
	...
	'COOKIES_DELETED'		=> 'All site cookies successfully deleted.',
	...
	'DELETE_COOKIES'		=> 'Delete all site cookies',
	'DELETE_MARKED'			=> 'Delete marked',
	'DELETE_POST'			=> 'Delete post',
	'DELETE_CAT'			=> 'Delete Category',
	'DELETE_CAT_CONFIRM'	=> 'Are you sure you wish to delete this category?',
	'DELIMITER'				=> 'Delimiter',
	...
	'ERR_WRONG_PATH_TO_SITE'			=> 'The site path specified appears to be invalid.',
	...
	'FTP_FSOCK_ROOT_PATH'			=> 'Path to site',
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Path from the root to your site.',
	...
	'FTP_ROOT_PATH'				=> 'Path to site',
	'FTP_ROOT_PATH_EXPLAIN'		=> 'Path from the root to your site.',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'To prevent brute forcing accounts the site requires you to enter a confirmation code after a maximum amount of failed logins. The code is displayed in the image you should see below. If you are visually impaired or cannot otherwise read this code please contact the %sSite Administrator%s.', // unused
	...
	'LOGIN_ERROR_PASSWORD'				=> 'You have specified an incorrect password. Please check your password and try again. If you continue to have problems please contact the %sSite Administrator%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'It was not possible to convert your password when updating this site’s software. Please %srequest a new password%s. If you continue to have problems please contact the %sSite Administrator%s.',
	'LOGIN_ERROR_USERNAME'				=> 'You have specified an incorrect username. Please check your username and try again. If you continue to have problems please contact the %sSite Administrator%s.',
	'LOGIN_INFO'						=> 'In order to login you must be registered. Registering takes only a few moments but gives you increased capabilities. The site administrator may also grant additional permissions to registered users. Before you register please ensure you are familiar with our terms of use and related policies. Please ensure you read any rules as you navigate around the site.',
	...
	'NOTIFY_ADMIN'				=> 'Please notify the site administrator or webmaster.',
	'NOTIFY_ADMIN_EMAIL'		=> 'Please notify the site administrator or webmaster: <a href="mailto:%1$s">%1$s</a>',
	...
	'NO_FEED_ENABLED'			=> 'Feeds are not available on this site.',
	...
	'REMOVE'					=> 'Remove',
	'REMOVE_INSTALL'			=> 'Please delete, move or rename the install directory before you use your site. If this directory is still present, only the Administration Control Panel (ACP) will be accessible.',
	'REPLIES'					=> 'Replies',
	...
	'SQL_ERROR_OCCURRED'		=> 'An SQL error occurred while fetching this page. Please contact the %sSite Administrator%s if this problem persists.',
	...
	'TODO_DELETE' => 'Delete Todo Item?',
	'TODO_DELETE_CONFIRM' => 'Are you sure you wish to delete this Todo list item permanently?',
